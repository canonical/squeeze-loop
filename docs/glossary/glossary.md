...
([squeeze-loop](squeeze-loop.md)) **forces new distinctions into existence** — the O4
...
[archetype](archetype.md)s, [tier](tier.md)s, [Gate S](gates.md), the
[reflexive-monitors](reflexive-monitors.md) — none of these existed before the loop
needed them; each was carved while resolving a squeeze.

A freshly carved concept is **soft**: like any [upper-bound](upper-bound.md)-side output
...
- Anchoring a concept is **naming**, not **validating**. A generated concept can be
  ...
  separate: the [reflexive-monitors](reflexive-monitors.md) (e.g. the over-reach audit)
...
- [squeeze-loop](squeeze-loop.md) — the generative pattern that creates the concepts.
- [reflexive-monitors](reflexive-monitors.md) — the checks that test a generated concept
  for over-reach after it is anchored.
- [strange-loop](strange-loop.md) — the self-applying construction whose generativity is
  what makes new concepts appear.
- [connective-tissue](connective-tissue.md) — the companion discipline: this anchors the
